...
export type FreeGiftQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type FreeGiftQuery = {
...
export type ShowcaseImagesQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type ShowcaseImagesQuery = {
...
> & {
  ...
  guidePrice?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  images: {
    nodes: Array<
      {__typename: 'Image'} & Pick<
        StorefrontAPI.Image,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query FreeGift {\n    product(handle: "sample-gene-2023-dog-tags") {\n      title\n      featuredImage {\n        url\n        altText\n      }\n      variants(first: 1) {\n        nodes {\n          id\n          availableForSale\n        }\n      }\n    }\n  }\n': {
    return: FreeGiftQuery;
    variables: FreeGiftQueryVariables;
  };
  '#graphql\n  query ShowcaseImages {\n    collection(handle: "homepage-showcase") {\n      products(first: 15) {\n        nodes {\n          featuredImage { url altText width height }\n        }\n      }\n    }\n  }\n': {
    return: ShowcaseImagesQuery;
    variables: ShowcaseImagesQueryVariables;
  };
