            ...
            <div className="footer-grid">
              ...
              <div className="footer-section footer-section-center">
                ...
                {newsletterStatus === 'error' && (
                  <p className="footer-disclaimer" style={{ color: '#c00' }}>
                    Something went wrong, please try again.
                  </p>
                )}
                <p className="footer-disclaimer">
                  By submitting this form you agree to receive updates about fly shit.{' '}
                  <Link to="/pages/terms-of-service">View Terms</Link> and{' '}
                  <Link to="/pages/privacy-policy">Privacy</Link>.
                </p>
                <div className="footer-socials">
                  <a href="https://instagram.com/jaffasaba" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
                    <InstagramIcon size={30} />
                  </a>
                  <a href="https://tiktok.com/@jaffasaba" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="TikTok">
                    <TikTokIcon size={30} />
                  </a>
                </div>
              </div>
